...
public class OpenSourceLicensesActivity extends AppBaseActivity implements CommonRecyclerAdapter
        .OnItemClickListener {
    ...
    public void onItemClick(RecyclerView.ViewHolder viewHolder, View view, int position) {
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(LICENSE_ARRAY.get(position)
                .projectUrl)));
    }
    ...
    private static class LicenseItem {
        ...
        LicenseItem(String title, String author, String licenseType, String logoUrl, String
                projectUrl) {
            this.title = title;
            this.author = author;
    ...
    private static final ImageLoad GLIDE_IMAGE_LOAD = new ImageLoad() {
        @Override
        public void load(@NonNull Context context, @NonNull ImageView imageView, @NonNull String
                imageUrl) {
            Glide.with(context)
                    .load(imageUrl)
    ...
    private static final class LicensesAdapter extends CommonRecyclerAdapter<LicenseItem> {
        ...
        @Override
        public void onUpdate(BaseAdapterHelper helper, LicenseItem item, int position) {
    ...
    static {
        ...
        LICENSE_ARRAY.add(new LicenseItem("CircleImageView", "Henning Dodenhof",
                LICENSE_TYPE_APACHE,
